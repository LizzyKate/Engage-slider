if (window.innerWidth <= 800) {
	const emblaNode = document.querySelector(".embla_mobile");
	const options = { loop: true };

	const embla = EmblaCarousel(emblaNode, options);

	const nextButton = document.querySelector("#next_mobile");
	const prevButton = document.querySelector("#prev_mobile");
